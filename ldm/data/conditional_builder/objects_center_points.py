...
from ldm.data.conditional_builder.utils import (
    COLOR_PALETTE,
    WHITE,
    GRAY_75,
    BLACK,
...
from ldm.data.image_transforms import convert_pil_to_tensor
...
class ObjectsCenterPointsConditionalBuilder:
    ...
    def build_dataset(self, annotations: List, crop_coordinates: Optional[BoundingBox] = None,
    ...
    def build_sample(self, annotations: List):
        if len(annotations) == 0:
            warnings.warn('Did not receive any annotations.')
